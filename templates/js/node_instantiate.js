...
class NodeInstantiatorClass {
    ...
    createBaseCardDiv() {
        ...
        this.base_card.style = "left:" + String(this.posX) + 'px;' + "top:" + String(this.posY) + 'px; '
    ...
    createExecutorDiv(){
        ...
        this.exeSlotInput.className = "form-control form-control-sm right_side_input"
    ...
    createResourcesDiv(){
        ...
        this.timeDiv = sc.createDiv("time_sq d-flex  justify-content-between h-auto")
        ...
        this.timeDivValueInput = sc.createInput("form-control right_side_input",'2h')
        ...
        this.moneyDiv = sc.createDiv("money_sq d-flex  justify-content-between h-auto")
        ...
        this.moneyDivValueInput = sc.createInput("form-control right_side_input",'120руб')
    ...
    createSubmitButton(){
        this.submitBtn = sc.createButton('btn btn-primary input_submit_btn','Submit')
